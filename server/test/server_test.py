...
class TestGetToken:
    ...
    def test_success(self, role: Role) -> None:
        """
...
class TestWebsocketEndpoint:
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("role", [Role.SOLVER, Role.VISUALIZER])
    async def test_success(self, websocket: DummyWebSocket, role: Role) -> None:
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("role", [Role.SOLVER, Role.VISUALIZER])
    async def test_disconnect(self, websocket: DummyWebSocket, role: Role) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_invalid_token(self, websocket: DummyWebSocket) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_invalid_role(self, websocket: DummyWebSocket) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_invalid_registration(self, websocket: DummyWebSocket) -> None:
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("role", [Role.SOLVER, Role.VISUALIZER])
    async def test_invalid_receive_json(self, websocket: DummyWebSocket, role: Role) -> None:
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("role", [Role.SOLVER, Role.VISUALIZER])
    async def test_invalid_handle_message(self, websocket: DummyWebSocket, role: Role) -> None:
        """
        Tests that websocket_endpoint handles any Exception raised by the websocket.
