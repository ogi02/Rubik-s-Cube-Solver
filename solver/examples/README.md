...
| [`08_solve_big_cubes.py`](08_solve_big_cubes.py) | Solving a 4x4, a 5x5 and a 9x9 through `create_solver`, replaying a solution on a second cube, and what an even or odd size changes about the solve. |
