...
class TestScramblerGenerateScramble:
    # fmt: off
    ...
    # fmt: on
    def test_success(self, scrambler: Scrambler, cube_size: int, scramble_length: int) -> None:
        """
    ...
    # fmt: on
    def test_invalid_random_move(self, scrambler: Scrambler, cube_size: int, scramble_length: int) -> None:
        """
        Tests generating a scramble when an invalid random move is encountered.
    ...
    # fmt: on
    def test_exception(
        self, scrambler: Scrambler, expected_exception_type: type[BaseException], expected_exception: str
    ) -> None:
        """
...
class TestScramblerGetScrambleLength:
    # fmt: off
    @pytest.mark.parametrize(
    ...
    # fmt: on
    def test_success(self, scrambler: Scrambler, cube_size: int, expected_length: int) -> None:
        """
...
class TestScramblerGenerateRandomMove:
    # fmt: off
    @pytest.mark.parametrize(
...
class TestScramblerIsValidRandomMove:
    # fmt: off
    @pytest.mark.parametrize(
    ...
    def test_no_previous_moves(
        ...
        """
        Tests that any move is valid when there are no previous moves.
...
class TestScramblerShouldAppendToPreviousMoves:
    # fmt: off
    @pytest.mark.parametrize(
        "layer, direction, layer_amount, expected", [
    ...
    def test_no_previous_moves(
        ...
        """
        Tests that no move is appended when there are no previous moves.
