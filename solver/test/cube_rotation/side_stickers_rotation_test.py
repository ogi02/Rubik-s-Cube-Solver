...
class TestGetEdge:
    ...
    @pytest.mark.parametrize(
        "layer_amount, position, cube_size, expected_edge", [
            ...
            (1, EdgePosition.TOP,    4, [Color.WHITE,  Color.YELLOW, Color.ORANGE, Color.RED]),
            (1, EdgePosition.BOTTOM, 4, [Color.WHITE,  Color.YELLOW, Color.ORANGE, Color.RED]),
            (1, EdgePosition.LEFT,   4, [Color.WHITE,  Color.GREEN,  Color.ORANGE, Color.WHITE]),
            (1, EdgePosition.RIGHT,  4, [Color.RED,    Color.YELLOW, Color.BLUE,   Color.RED]),
    ...
    @pytest.mark.parametrize(
        "layer_amount, position, cube_size, expected_face", [
            ...
            (1, EdgePosition.TOP,    4, [Color.WHITE,  Color.YELLOW, Color.ORANGE, Color.RED,
                                         ...
                                         Color.WHITE,  Color.WHITE,  Color.WHITE,  Color.WHITE,
                                         Color.WHITE,  Color.WHITE,  Color.WHITE,  Color.WHITE]),
            (1, EdgePosition.BOTTOM, 4, [Color.WHITE,  Color.WHITE,  Color.WHITE,  Color.WHITE,
                                         Color.WHITE,  Color.WHITE,  Color.WHITE,  Color.WHITE,
                                         Color.WHITE,  Color.WHITE,  Color.WHITE,  Color.WHITE,
                                         Color.WHITE,  Color.YELLOW, Color.ORANGE, Color.RED]),
            (1, EdgePosition.LEFT,   4, [Color.WHITE,  Color.WHITE,  Color.WHITE,  Color.WHITE,
                                         Color.YELLOW, Color.WHITE,  Color.WHITE,  Color.WHITE,
                                         Color.ORANGE, Color.WHITE,  Color.WHITE,  Color.WHITE,
                                         Color.RED,    Color.WHITE,  Color.WHITE,  Color.WHITE]),
            (1, EdgePosition.RIGHT,  4, [Color.WHITE,  Color.WHITE,  Color.WHITE,  Color.WHITE,
...
class TestShouldFlipEdge:
    ...
    # fmt: on
    def test_success(self, turned_layer: Layer, direction: Direction, adj_layer: Layer, should_flip_edge: bool) -> None:
        """
...
class TestRotateSides:
    ...
    @pytest.mark.parametrize(
        "cube_size, turned_layer, direction, layer_amount, original_edges", [
            ...
            (4, Layer.UP,    Direction.CW,     1, [Color.BLUE,  Color.RED,    Color.GREEN,  Color.ORANGE]),
            (4, Layer.UP,    Direction.CCW,    1, [Color.BLUE,  Color.RED,    Color.GREEN,  Color.ORANGE]),
            (4, Layer.UP,    Direction.DOUBLE, 1, [Color.BLUE,  Color.RED,    Color.GREEN,  Color.ORANGE]),
            (4, Layer.DOWN,  Direction.CW,     1, [Color.GREEN, Color.RED,    Color.BLUE,   Color.ORANGE]),
            (4, Layer.DOWN,  Direction.CCW,    1, [Color.GREEN, Color.RED,    Color.BLUE,   Color.ORANGE]),
            (4, Layer.DOWN,  Direction.DOUBLE, 1, [Color.GREEN, Color.RED,    Color.BLUE,   Color.ORANGE]),
            (4, Layer.FRONT, Direction.CW,     1, [Color.WHITE, Color.RED,    Color.YELLOW, Color.ORANGE]),
            (4, Layer.FRONT, Direction.CCW,    1, [Color.WHITE, Color.RED,    Color.YELLOW, Color.ORANGE]),
            (4, Layer.FRONT, Direction.DOUBLE, 1, [Color.WHITE, Color.RED,    Color.YELLOW, Color.ORANGE]),
            (4, Layer.BACK,  Direction.CW,     1, [Color.WHITE, Color.ORANGE, Color.YELLOW, Color.RED]),
            (4, Layer.BACK,  Direction.CCW,    1, [Color.WHITE, Color.ORANGE, Color.YELLOW, Color.RED]),
            (4, Layer.BACK,  Direction.DOUBLE, 1, [Color.WHITE, Color.ORANGE, Color.YELLOW, Color.RED]),
            (4, Layer.LEFT,  Direction.CW,     1, [Color.WHITE, Color.GREEN,  Color.YELLOW, Color.BLUE]),
            (4, Layer.LEFT,  Direction.CCW,    1, [Color.WHITE, Color.GREEN,  Color.YELLOW, Color.BLUE]),
            (4, Layer.LEFT,  Direction.DOUBLE, 1, [Color.WHITE, Color.GREEN,  Color.YELLOW, Color.BLUE]),
            (4, Layer.RIGHT, Direction.CW,     1, [Color.WHITE, Color.BLUE,   Color.YELLOW, Color.GREEN]),
            (4, Layer.RIGHT, Direction.CCW,    1, [Color.WHITE, Color.BLUE,   Color.YELLOW, Color.GREEN]),
            (4, Layer.RIGHT, Direction.DOUBLE, 1, [Color.WHITE, Color.BLUE,   Color.YELLOW, Color.GREEN]),
