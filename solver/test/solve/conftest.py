...
@pytest.fixture
def generate_2x2_oll_case(generate_cube: Callable[[int, str], Cube]) -> Callable[[str], Cube]:
    """
    Returns a function that generates the 2x2 OLL case a given orientation algorithm solves.
    ...
    def _generate(algorithm: str) -> Cube:
        """
        Generates the 2x2 OLL case a given orientation algorithm solves, by applying it backwards to
        a solved cube. The first layer stays solved, so only the last layer is off - its corners
        twisted, and permuted along with them.
...
@pytest.fixture
def generate_2x2_pll_case(generate_cube: Callable[[int, str], Cube]) -> Callable[[str], Cube]:
    """
    Returns a function that generates the 2x2 PLL case a given permutation algorithm solves.
    ...
    def _generate(algorithm: str) -> Cube:
        """
        Generates the 2x2 PLL case a given permutation algorithm solves, by applying it backwards to
        a solved cube. The first layer stays solved and the UP face keeps showing one color, so only
        the permutation of the last layer is off.
...
@pytest.fixture
def generate_3x3_oll_case(generate_cube: Callable[[int, str], Cube]) -> Callable[[str], Cube]:
    """
    Returns a function that generates the 3x3 OLL case a given orientation algorithm solves.
    ...
    def _generate(algorithm: str) -> Cube:
        """
        Generates the 3x3 OLL case a given orientation algorithm solves, by applying it backwards to a
...
@pytest.fixture
def generate_3x3_pll_case(generate_cube: Callable[[int, str], Cube]) -> Callable[[str], Cube]:
    """
    Returns a function that generates the 3x3 PLL case a given permutation algorithm solves.
    ...
    def _generate(algorithm: str) -> Cube:
        """
        Generates the 3x3 PLL case a given permutation algorithm solves, by applying it backwards to a
