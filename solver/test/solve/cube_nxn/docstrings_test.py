...
from rubik_cube_solver.solve.cube_nxn import centers, pieces, routes

# The names the examples use without importing them: the types every example builds its cube from,
# and the functions and constants of all three modules, since an example in one module may use a
...
class TestDocstringExamples:
    # fmt: off
    @pytest.mark.parametrize("module", [pieces, routes, centers])
    # fmt: on
