...
from rubik_cube_solver.solve.cube_nxn import (
    centers,
    edges,
    last_centers,
    last_edges,
...
# and the functions and constants of all eight modules, since an example in one module may use a
...
class TestDocstringExamples:
    # fmt: off
    @pytest.mark.parametrize("module", [pieces, routes, centers, last_centers, edges, last_edges, parity, reduced_3x3])
    # fmt: on
