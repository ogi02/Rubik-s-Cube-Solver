...
class TestWebSocketClientAuthenticate:
    """
    Tests for WebSocketClient.authenticate.
    """

    def test_success(self, client: WebSocketClient) -> None:
        """
    ...
    def test_invalid_get_request(self, client: WebSocketClient) -> None:
        """
    ...
    def test_invalid_json(self, client: WebSocketClient) -> None:
        """
        Tests authentication failure due to an invalid JSON response.
    ...
    def test_invalid_missing_token(self, client: WebSocketClient) -> None:
        """
...
class TestWebSocketClientConnect:
    """
    Tests for WebSocketClient._connect.
    """

    @pytest.mark.asyncio
    async def test_success(self, client: WebSocketClient) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_invalid_missing_token(self, client: WebSocketClient) -> None:
        """
...
class TestWebSocketClientReceiver:
    """
    Tests for WebSocketClient._receiver.
    """

    @pytest.mark.asyncio
    async def test_no_message_handler(self, client: WebSocketClient) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_message_handler(self, client: WebSocketClient, message_handler: Callable[[dict], None]) -> None:
        """
    ...
    async def test_async_message_handler(
        self, client: WebSocketClient, async_message_handler: Callable[[dict], Awaitable[None]]
    ) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_non_json_message(self, client: WebSocketClient) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_connection_closed(self, client: WebSocketClient) -> None:
        """
    ...
    @pytest.mark.asyncio
    async def test_asyncio_cancelled(self, client: WebSocketClient) -> None:
        """
...
class TestWebSocketClientSender:
    """
    Tests for WebSocketClient._sender.
    """
...
class TestWebSocketClientPinger:
    """
    Tests for WebSocketClient._pinger.
    """
...
class TestWebSocketClientSendMessage:
    """
    Tests for WebSocketClient.send_message.
    """
...
class TestWebSocketClientClose:
    """
    Tests for WebSocketClient.close.
    """
